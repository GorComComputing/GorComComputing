...
Привет! :smiley:  
Мой репозиторий посвящен программированию на разных уровнях. От создания низкоуровневой логики процессора, операционной системы и компилятора...  
...
Каждая прикладная программа в такой системе видит свой плоский объем памяти, обладает квантом процессорного времени и для связи с внешними устройствами или другими программами использует вызовы ядра операционной системы. Внутри плоского объема памяти программа хранит свои структуры данных и алгоритмы. Если в прикладной программе разместить структуры и алгоритмы ядра операционной системы, то получим операционную систему внутри операционной системы.  
...
* [Операционная система Doors в браузере](https://github.com/GorComComputing/GUI_DOORS_Go) (на Go) **Посмотреть как работает [www.gorcom.online](http://www.gorcom.online) Вход без пароля!**
...
* [Текстовый редактор](https://github.com/GorComComputing/TextEditor) (на C)
...
* [Shell для утилиты Chrony (NTP)](https://github.com/GorComComputing/Shell_Chrony) (на Go)
...
* [Домашний робот на RP2040](https://github.com/GorComComputing/PICO) (на C++ Arduino)
* [Промышленный робот манипулятор на ESP32](https://github.com/GorComComputing/ArmRobot) (на C++ Arduino)
