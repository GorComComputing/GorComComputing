...
Каждая прикладная программа в такой системе видит свой плоский объем памяти, обладает квантом процессорного времени и для связи с внешними устройствами или другими программами использует вызовы ядра операционной системы. Внутри плоского объема памяти программа хранит свои структуры и алгоритмы. Если в прикладной программе разместить структуры и алгоритмы ядра операционной системы, то получим операционную систему внутри операционной системы. Если опуститься глубже и дополнительно разместить внутри прикладной программы структуры и алгоритмы, которые содержит микропроцессор, то мы получим компьютер внутри компьютера.

Так есть возможность создавать неограниченное число компьютеров всех видов архитектур, как существующих, так и придумывать новые. Интересным выглядит тот методологический факт, что мы можем не только запустить машину Тьюринга на современном Core i7, но и запустить Core i7 на машине Тьюринга. 
